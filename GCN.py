...
if __name__ == '__main__':
    ...
    train_dataset = MyDataset(f=mogen_fp[0:8000], f1=fp1[0:8000], f2=fp2[0:8000], f3=fp3[0:8000], f4=fp4[0:8000],
                              X=X[0:8000], A=A[0:8000], label=labels[0:8000])
    train_loader = DataLoader(train_dataset, batch_size=100, shuffle=True, drop_last=True)
    test_dataset = MyDataset(f=mogen_fp[8000:], f1=fp1[8000:], f2=fp2[8000:], f3=fp3[8000:], f4=fp4[8000:], X=X[8000:],
                             A=A[8000:], label=labels[8000:])
